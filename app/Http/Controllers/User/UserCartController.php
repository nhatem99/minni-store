...
class UserCartController extends Controller {
    ...
    function addProductCart($id) {
        ...
        $txt = "";
        $txt_size = '<div style="font-size: 16px;font-weight: 600; margin: 15px 0px;">Kích Thước</div><div class="list-product-size">';
        $t = 1;
        $y =1;
        $txt_color = '<div class="list-product-color" >';
        foreach ($productColors as $item) {
            ...
            $txt_color .= '<div class="product-color ' . $active . '">
        ...
        foreach ($productSizes as $item) {
            ...
            // $checked = "";
            $txt_size .= '<div class="product-size ' . $active . '">
            
                <input type="radio" id="swatch-'. $item->id.'"' . $checked . ' name="check-size-cart" value="' . $item->id . '" />
