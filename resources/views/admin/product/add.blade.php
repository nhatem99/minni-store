                ...
                <form method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control @error('name') is-invalid @enderror" type="text" name="name"
                            id="name" value="{{ old('name') }}" placeholder="Nhập tên sản phẩm">
                        @error('name')
                    ...
                    <div class="form-row">
                        <div class="col-md-5">
                            <div class="form-group">
                                ...
                                <input id="img" type="file" name="feature_image" data-img="avatar"
                            ...
                            <div class="form-group">
                                <label>Ảnh 2</label>
                                <input type="file" multiple class="form-control-file d-none" name="feature_image2"
                                    data-img="avatar-2" onchange="changeImg(this)">
                                <img id="avatar-2" class="img-thumbnail d-block" width="200px"
                                    src="{{ asset('public/admins/img/upload_img.png') }}">
                                @error('feature_image2')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                            <div class="form-group">
                                <label for="">Ảnh chi tiết về sản phẩm</label>
                                <input type="file" multiple class="form-control-file d-none" name="image_product"
                                data-img="avatar-3" value="{{ old('image_product[]') }}" onchange="changeImg(this)">
                                <img id="avatar-3" class="img-thumbnail d-block" width="200px"
                                    src="{{ asset('public/admins/img/upload_img.png') }}">
                                @error('image_product')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                        ...
                        <div class="col-md-7">
                            ...
                            <div class="form-group">
                                <label>Kích cõ sản phẩm</label>
                                <div class="input_size_wrap">
                                    <button class="btn btn-info add_size_button mb-2">Thêm Size</button>
                                    <div class="form-row">
                                        <div class="form-group col-md-4">
                                            ...
                                            @enderror
                                            <input type="text"
                                                class="form-control @error('name_size') is-invalid @enderror"
                                                name="name_size[]" placeholder="Nhập size sản phẩm">
                                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description" class="form-control content @error('description') is-invalid @enderror" id="content"
                            cols="30" rows="5" placeholder="Nhập nội dung bài viết">{{ old('description') }}</textarea>
                        @error('description')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="status" id="public1"
                                    value="1" checked>
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="status" id="pending1"
                                    value="0">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="featured" id="yes"
                                    value="1">
