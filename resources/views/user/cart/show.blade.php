                        ...
                        <tbody>
                            @foreach (Cart::content() as $item)
                                <tr>
                                    ...
                                    <td style="font-weight: 700">{{ $item->options->size_name }}</td>
                                    ...
                                    <td style="color: red; font-weight: 700;" id="sub-total-{{ $item->rowId }}">
                                        {{ number_format($item->price * $item->qty, 0, ',', '.') }}đ</td>
                                    <td>
                                        <a href="" data-url="{{ route('cart.delete', ['rowId' => $item->rowId]) }}"
                                            data-rowId={{ $item->rowId }}
                                            class="btn btn-danger btn-sm text-white action_delete" title="Delete"><i
